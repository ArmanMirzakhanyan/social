            ...
            <div class="editing-info">
                ...
                <form method="post" action="{{route('updateprofile')}}">
                    ...
                    <div class="form-group">
                        <input name="name" type="text" id="input" required="required" value="{{ Auth::user()->name }}" />
                        <label class="control-label" for="input">First Name</label><i class="mtrl-select"></i>
                    </div>
                    <div class="form-group">
                        <input name="email" type="text" required="required" value="{{ Auth::user()->email}}"/>
                    ...
                    <div class="dob">
                        <div class="form-group">
                            <input name="birthdate" id="date" class="date form-control" type="text" name="birthdate" required="required"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <textarea rows="4" id="textarea" required="required" name="aboutme"></textarea>
